...
use DigitalStars\SimpleVK\Tests\V4\tmp_actions\CatchAllAction;
use DigitalStars\SimpleVK\Tests\V4\tmp_actions\PingBtn;
use DigitalStars\SimpleVK\Tests\V4\tmp_actions\StartAction;
use DigitalStars\SimpleVK\V4\ApiClient;
use DigitalStars\SimpleVK\V4\Config\ClientConfig;
use DigitalStars\SimpleVK\V4\Dispatcher\ArgumentResolver;
use DigitalStars\SimpleVK\V4\Dispatcher\Context;
use DigitalStars\SimpleVK\V4\Dispatcher\EventDispatcher;
use DigitalStars\SimpleVK\V4\Message\Keyboard;
use DigitalStars\SimpleVK\V4\Service\ErrorReporter;
use DigitalStars\SimpleVK\V4\Transport\FakeTransport;
use DigitalStars\SimpleVK\V4\WebhookHandler;
...
final class DispatcherTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->dispatcher = new EventDispatcher(
            new \DigitalStars\SimpleVK\V4\Dispatcher\DispatcherConfig([$this->actionsDir]),
    ...
    public function testDedupDropsDuplicateEvents(): void
    {
        ...
        $bot = new \DigitalStars\SimpleVK\V4\Bot($config, new ApiClient($config, $this->fake));
    ...
    private function incomingMessage(
        string $text,
        ?string $payload = null,
    ): \DigitalStars\SimpleVK\V4\Message\IncomingMessage {
        $config = ClientConfig::create('T', 9);
        $update = \DigitalStars\SimpleVK\V4\Event\Update::fromLongPoll([
            'type' => 'message_new',
            'event_id' => 'e' . \mt_rand(),
            'group_id' => 9,
            'object' => [
        ...
        return new \DigitalStars\SimpleVK\V4\Message\IncomingMessage(
            update: $update,
