...
use DigitalStars\SimpleVK\V4\Message\CallbackAnswer;
use DigitalStars\SimpleVK\V4\Service\Mentions;
use DigitalStars\SimpleVK\V4\Service\UserInfo;
...
final class ServicesTest extends TestCase
{
    ...
    {
        $failing = new class implements \DigitalStars\SimpleVK\V4\Transport\Transport {
            public function call(string $method, array $params = []): array
            {
                throw new \DigitalStars\SimpleVK\V4\Exception\SimpleVkException(15, 'denied');
            }
        };
