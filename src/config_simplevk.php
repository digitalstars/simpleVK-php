...
// Массив кодов ошибок ВК, при которых идёт 5 попыток выполнить этот запрос с перерывом в 10 секунд
const SIMPLEVK_VERSION = '3.9.2';

const ERROR_CODES_FOR_MANY_TRY = [
    1, //Произошла неизвестная ошибка.
    6, //Слишком много запросов в секунду (флуд контроль)
    // 8, //Очень редко может выдать Invalid request: this method can not be called that way. Но в целом эта же ошибка используется для обозначения, что версия vk api устарела
