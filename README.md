...
Теперь эта вертка для тестирования, если вы искали SimpleVK 3, то он теперь в основной ветке:  
[https://github.com/digitalstars/simpleVK-php/](https://github.com/digitalstars/simpleVK-php/)
