...
<p align="center">
<img src="https://img.shields.io/badge/VK_API-%3E=%205.124-8992bb.svg" alt="VK api version">
...
> ## ⚠️ Внимание!
> **Версия SimpleVK 2 устарела и больше не поддерживается!**
> 
> Данная ветка содержит версию SimpleVK v2, которая больше не развивается.
>
> Теперь команда установки по умолчанию устанавливает версию 3:
> ```bash
