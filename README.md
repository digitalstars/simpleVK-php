...
Отлично! Теперь, когда всё работает, нужно правильно и понятно это описать. Вы правы, раздел "Установка" — один из самых важных в `README`.

Вот готовый блок для вашего `README.md`. Он структурирован так, чтобы четко разделить два способа установки, объясняя, для кого предназначен каждый из них, и делая акцент на Composer как на рекомендуемом методе.

---

## Установка

Вы можете установить библиотеку одним из двух способов.
